...
$query = "SELECT * FROM doctor WHERE Name = '$ad'";
                            ...
                            <div class="col-md-6">
                                ...
                                if (isset($_POST['update'])) {
                                    ...
                                    if (empty($profile)) {
                                        ...
                                        $query = "UPDATE doctor SET image = '$profile' WHERE Name = '$ad'";
                            ...
                            <div class="col-md-6">
                                <?php
                                    if(isset($_POST['update_pass'])) {
                                        ...
                                        $old = mysqli_query($con, "SELECT * FROM doctor WHERE Name = '$ad'");
                                        ...
                                        if(count($error)==0){
                                            $query = "UPDATE doctor SET password = '$new_pass' WHERE Name= '$ad'";
